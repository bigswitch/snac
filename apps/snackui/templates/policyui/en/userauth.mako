...
<%def name="page_title()">User Authentication Rules</%def>

<%def name="dojo_imports()">
  ${parent.dojo_imports()}
  @import "/static/nox/ext/apps/snackui/policyui/rules.css";
  @import "/static/nox/ext/apps/snackui/policyui/userauthrules.css";
</%def>
...
<%def name="dojo_requires()">
  ...
  dojo.require("nox.ext.apps.snackui.policyui.userauthrules");
</%def>
