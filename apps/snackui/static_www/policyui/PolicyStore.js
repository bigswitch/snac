...
dojo.declare("nox.ext.apps.snackui.policyui.PolicyStore", [ nox.ext.apps.coreui.coreui._UpdatingStore ], {
    ...
    _handleServerResponse: function (response, ioArgs) {
        ...
        if (this.policyId != this._pendingPolicyId) {
            this.updatemgr.xhrGet({
                ...
                load: dojo.hitch(this, nox.ext.apps.coreui.coreui._UpdatingStore.prototype._handleServerResponse),
