...
dojo.addOnLoad(function () {
    coreui.base.set_nav_title([
        ...
        {
            title_text: "User Groups",
            nav_text: "Users",
            nav_uri: "/Monitors/Groups/UserGroups"
        }
    ]);
    groupsStore = new dmws.UserGroupStore({
    ...
    group_util.setup_listpage_edit_hooks("user", groupsStore, dmws.UserGroup,
                                         groupsTable, function(name) {
                                             return name != "network_admin_superusers";
                                         });
});
