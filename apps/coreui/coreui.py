...
class coreui(Component):
    ...
    def __init__(self, ctxt):
        ...
        self.siteConfig = {}  # Dictionary of attribute/values that will be
                              ...
                              # determined.
        self.siteConfig['coreui'] = self

        # we should not serve up any pages until our
        # authentication infrastructure has been intialized
    ...
    def install(self):
        ...
        self.static_root = static.File(self.STATIC_FILE_BASEPATH)
                        ...
                        class RedirectRes(resource.Resource):
                            ...
                            def render_GET(self, request):
                                if not self.component.ssl_port:
                                    ...
                                    new_uri = 'http://%s:%d%s' % \
                                        (host.host, self.component.port.port, 
                                         request.uri)
