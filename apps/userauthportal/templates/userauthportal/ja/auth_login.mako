...
<p><span class="errormsg">ログインに失敗しました。入力内容をもう一度ご確認ください。</span></p>
% endif
% if dev_fake == True:
<!--
...
% endif
<h1>アクセス認証が必要です</h1>
<p>このネットワークにアクセスするためログインが必要です。</p>
  ...
  <form id="login" name="login" action="${r.do_login}" method="post" onSubmit="lopu(this, '${r.opening_pu}', '${r.wait_for_pu}')">
    <table>
      ...
      <tr>
        ...
        <input name="Log In" type="submit" tabindex="3" value="ログイン">
        </td>
      </tr>
    </table>
